...
```{r}
plot(x=interval_weekday$interval,y=interval_weekday$mean_steps,type="l")
plot(x=interval_weekend$interval,y=interval_weekend$mean_steps,type="l")
print(xyplot(interval_weekpart$mean_steps ~ interval_weekpart$interval, factor = interval_weekpart$is.weekend, type="l"))
```